...
const styles = StyleSheet.create({
  ...
  cardName: { fontSize: 15, fontFamily: 'Comfortaa_600SemiBold' },
  cardSub: { fontSize: 13 },
  cardRight: { alignItems: 'flex-end', gap: 2 },
  cardAmount: { fontSize: 16, fontFamily: 'Comfortaa_700Bold' },
  ...
  dueText: { fontSize: 13, fontFamily: 'Comfortaa_500Medium' },
  ...
  chipText: { fontSize: 14, fontFamily: 'Comfortaa_500Medium' },
  ...
  deleteBtnText: { fontSize: 15, fontFamily: 'Comfortaa_600SemiBold' },
});
